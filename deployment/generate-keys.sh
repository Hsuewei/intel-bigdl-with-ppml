#!/bin/bash
SSL_NAMESPACE=$1
SSL_KEYS_SECRET_NAME=$2
SSL_SRC_KEYSTORE_PASS=$3
SSL_DEST_KEYSTORE_PASS=$4
...
##
# step 1
openssl pkcs12 -export -in server.pem -out keystore.pkcs12 -passout pass:${SSL_SRC_KEYSTORE_PASS}
...
keytool -importkeystore \
    ...
    -srcstoretype PKCS12 \
    -srcstorepass ${SSL_SRC_KEYSTORE_PASS} \
    -destkeystore keystore.jks \
    -deststoretype JKS \
    -storepass ${SSL_DEST_KEYSTORE_PASS}
...
# 會有 prompt >>> Enter Import Password:
openssl pkcs12 \
    -in keystore.pkcs12 \
    -nodes \
    -out server.pem \
    -password pass:${SSL_SRC_KEYSTORE_PASS}
# 沒有 prompt
