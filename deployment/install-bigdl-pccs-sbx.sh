...
# apiKey from alan
export apiKey="2a3b782d9fd04aecb2e3997ba442b858"
# 
...
data:
  pccs_entrypoint_sh: |
    ...
    # 20230301 alan 
    # use sandbox intel provision service.
    # the pcs url for production server is:
    # "https://api.trustedservices.intel.com/sgx/certification/v3/"
    # the pcs url for pre-production server is:
    # "https://sbx.api.trustedservices.intel.com/sgx/certification/v3/"
    sed -i 's/"uri": "https:\\/\\/api.trustedservices.intel.com\\/sgx\\/certification\\/v3\\/",/"uri": "https:\\/\\/sbx.api.trustedservices.intel.com\\/sgx\\/certification\\/v3\\/",/g' default.json
    ...
    # 20230301 alan
    # According to Intel experts, changed PCCS mode from LAZY to REQ
    sed -i 's/"CachingFillMode" : "LAZY",/"CachingFillMode" : "REQ",/g' default.json
